...
def main():
    ...
    parser.add_argument('--model_name', type=str,
                        default=f'nezha-cn-base')
    parser.add_argument('--pretrain_model_path', type=str, # VisualBert  
                        default=f'./prev_trained_model/nezha-cn-base')
...
#                         default=f'./prev_trained_model/nezha-cn-base/vocab.txt')
    parser.add_argument('--save_path', type=str,
                        default='./new_self_pretrained_model/nezha-cn-base')
    parser.add_argument('--record_save_path', type=str,
                        default='./new_self_pretrained_model_record/nezha-cn-base')
