...
from transformers import AutoTokenizer, AutoModel, AutoConfig, BertTokenizer,AutoModelForMaskedLM, VisualBertForPreTraining, BertConfig, PreTrainedTokenizer
...
class DataCollatorForNgram:
    def __init__(self, max_seq_len: int, tokenizer: BertTokenizer, plm_probability=0.15):
        self.max_seq_len = max_seq_len
        self.tokenizer = tokenizer
...
def load_data(args, tokenizer):
    ...
    #collate_fn = DataCollatorForNgram(args.max_seq_len, tokenizer)
...
def build_model_and_tokenizer(args):
    ...
    'chinese-roberta-wwm-ext': (BertConfig, AutoModelForMaskedLM, BertTokenizer),
    'nezha-cn-base': (NeZhaConfig, NeZhaForMaskedLM, BertTokenizer),
    'nezha-base-wwm': (NeZhaConfig, NeZhaForMaskedLM, BertTokenizer),
    'ernie-gram-zh': (BertConfig, AutoModelForMaskedLM, BertTokenizer),
...
def main():
    ...
    parser.add_argument('--model_name', type=str,
                        default=f'ernie-gram-zh')
    parser.add_argument('--pretrain_model_path', type=str, # VisualBert  
                        default=f'./prev_trained_model/ernie-gram-zh')
...
#                         default=f'./prev_trained_model/nezha-cn-base/vocab.txt')
    parser.add_argument('--save_path', type=str,
                        default='./new_self_pretrained_model/ernie-gram-zh')
    parser.add_argument('--record_save_path', type=str,
                        default='./new_self_pretrained_model_record/ernie-gram-zh')
