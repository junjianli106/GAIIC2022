...
class CFGs:
    def __init__(self):
        ...
        self.tokenizer_path = 'data/pretrain_model/nezha-cn-base'
        self.model_path = 'data/pretrain_model/nezha-cn-base'
...
#             logger.info(f'\n')
            ...
            if epoch_acc > best_acc:
                ...
                torch.save(state_dict, f'{CFG.out_dir}/model_nezha_fold{fold}.pth')
